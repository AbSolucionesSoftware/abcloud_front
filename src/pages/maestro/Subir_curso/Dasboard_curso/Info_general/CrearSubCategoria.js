...
export default function CrearSubCategoriaEnCurso({
  categorias,
  update,
  setUpdate,
  setSnackbar,
  ...
  const { datos, setDatos } = useContext(CursoContext);
  ...
  return (
    <div>
      <IconButton variant="contained" color="primary" onClick={handleClickOpen} disabled={!datos.category}>
        <Add />
      </IconButton>
      <Dialog
        open={open}
