...
export default function EstudiantesCurso() {
  ...
  const obtenerEstudiantesInscritos = useCallback(async () => {
    if (!datos._id) return;
    setLoading(true);
    await clienteAxios
        ...
        <Table stickyHeader aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell>Código descuento</TableCell>
...
const TableInfoBody = ({
  ...
  const codigo =
    alumno.coupon_discount && alumno.coupon_discount.percent_discount
      ? alumno.coupon_discount.coupon_code
      : "";
