...
function ExportarExcel({ estudiantes }) {
	...
	const data = estudiantes.map((data) => {
        ...
        estudiante.coupon_discount = data.coupon_discount && data.coupon_discount.percent_discount ? data.coupon_discount.coupon_code : '';
            ...
            <Grid>
				...
				>
					<ExcelSheet data={data} name="Datos de los estudiantes">
						...
						<ExcelColumn label="Código descuento" value="coupon_discount" />
					</ExcelSheet>
				</ExcelFile>
                </Grid>
            </Grid>
