...
import { ArrowBack, Close, Done, Notifications, QueuePlayNext } from "@material-ui/icons";
...
export default function NavegacionContenidoCurso(props) {
  ...
  const { datos, setDatos, update, setUpdate, setPreview } = useContext(
    CursoContext
  );
  ...
  const drawer = (
    <div>
      ...
      <Hidden mdUp>
        <div className={classes.toolbar}>
          <IconButton onClick={handleDrawerToggle}>
            {theme.direction === "rtl" ? <ChevronRightIcon /> : <Close />}
          </IconButton>
        </div>
      </Hidden>
      <Box ml={3} className={classes.drawHeight}>
        ...
        >
          ...
          <Button
            ...
            startIcon={datos.publication ? <Done /> : null}
          >
      ...
      <Box mt={1} ml={3}>
        {/* <Typography variant="button">Más opciones</Typography> */}
        <Divider />
        <List className={classes.root}>
          <List className={classes.root}>
            <ListItem
              ...
              style={{ paddingTop: "4px", paddingBottom: "4px" }}
              component={Link}
              to={`/instructor/contenido_curso/${idcurso}/taller`}
              onClick={() => {
                setTitle("Información Taller");
                setMobileOpen(false);
              }}
            >
              <ListItemIcon>
              ...
              <ListItemText primary="Información Taller" />
            </ListItem>
            <ListItem
              button
              style={{ paddingTop: "4px", paddingBottom: "4px" }}
            ...
            <ListItem
              ...
              style={{ paddingTop: "4px", paddingBottom: "4px" }}
              component={Link}
              to={`/instructor/contenido_curso/${idcurso}/notificaciones`}
              onClick={() => {
                setTitle("Notificaciones de este curso");
                setMobileOpen(false);
              }}
            >
              <ListItemIcon>
            ...
            {/* <ListItem
              ...
              style={{ paddingTop: "4px", paddingBottom: "4px" }}
              component={Link}
              to={`/instructor/contenido_curso/${idcurso}/taller_aprendizajes`}
              onClick={() => {
                setTitle("Aprendizajes de Taller");
                setMobileOpen(false);
              }}
            >
              <ListItemIcon>
              ...
              <ListItemText primary="Aprendizajes de Taller" />
            </ListItem> */}
            {/* <ListItem
              button
              style={{ paddingTop: "4px", paddingBottom: "4px" }}
              component={Link}
              to={`/instructor/contenido_curso/${idcurso}/alumnostaller`}
              onClick={() => {
