  ...
  return (
    <Container>
      ...
      <Box my={3}>
        ...
        <Box textAlign="justify" className="politicas_privacidad">
          <div>
            <p>
              {" "}
              Gracias por unirte a nosotros, en ABCloud queremos agradecerte por
              ser parte de este gran movimiento, queremos hacerte saber que tú
              eres muy importante para nosotros, es por eso que en cumplimiento
              con Ley Federal de Protección de Datos Personales en Posesión de
              Particulares publicada en el Diario Oficial de la Federación el 5
              de julio de 2010, pone a su disposición el presente Aviso de
              Privacidad para informarle la forma en que recabamos, protegemos,
              transferimos y utilizamos su información confidencial. Te
              recordamos que puedes acceder al contenido de la Ley citada a
              través del portal de la Cámara de Diputados del H. Congreso de la
              Unión
            ...
            <p>
              ...
              Personales será ABCloud.
            </p>
            <p>
              {" "}
              d) Plataforma: Plataforma o sitio web de ABCloud, en el cual se
              genera de forma espontánea información para estudios de mercado de
            ...
            <p>
              Los siguientes datos personales serán recabados por ABCloud de la
              manera descrita en el presente Aviso de Privacidad: -Datos de
              identificación: se podrá recabar su nombre y apellido; domicilio
              particular, laboral o fiscal; fecha de nacimiento; país y entidad
              de nacimiento, edad; nacionalidad, estado civil, ocupación,
              profesión, actividad o giro del negocio al que se dedique; números
              telefónicos fijos de casa, celulares y/ o de trabajo, correos
              electrónicos, estudios realizados, dependientes económicos, datos
              financieros, Clave Única de Registro de Población (CURP); Clave
              del Registro Federal de Contribuyentes. -ABCloud no recaba ningún
              dato personal sensible a través de su sitio web ni de ningún
              medio.
            </p>
            <h5>
            ...
            <p>
              Las finalidades principales por las que ABCloud recabará sus datos
            ...
            <p>
              ...
              plataformas. ABCloud escuela al revés hará uso de su Datos
          ...
          <p>
            {" "}
            Las finalidades por las que ABCloud recaba sus Datos Personales son
            para cumplir con obligaciones derivadas del uso de su Plataforma,
            para fines estadísticos, para informar sobre cambios o nuevos
            productos o servicios, evaluar la calidad del servicio, determinar
            la calidad de nuestros productos y servicios, intercambiar
            información necesaria para atender auditorías internas, externas y
            por autoridades, así como para fines mercadotécnicos, publicitarios
            y/o de prospección comercial y para otorgar beneficios y dar
            cumplimiento a obligaciones contraídas y para realizar estudios
            internos sobre hábitos de consumo.
          </p>
          <h5>V. TRANSFERENCIA DE DATOS</h5>
          <p>
            Usted acepta y reconoce que ABCloud podrá realizar las
            transferencias de sus datos personas como se describe a
            continuación:
          </p>
          <p>
            a) Otras personas que trabajan con y para ABCloud. ABCloud usa
            determinados terceros de confianza (por ejemplo, proveedores de
            soporte para clientes y servicios de informática) para prestar,
            mejorar, proteger y promocionar los Servicios. Estos terceros
            solamente tendrán acceso a tu información para llevar a cabo tareas
            en representación nuestra y de conformidad con esta Política de
            privacidad. La forma en que procesen tu información según nuestras
            instrucciones será nuestra responsabilidad.
          </p>
          <p>
          ...
          <p>
            c) prevenir fraudes o abuso contra ABCloud o contra nuestros
            usuarios;
          </p>
          <p>
            d) proteger los derechos, la propiedad, la seguridad o los intereses
            de ABCloud escuela al revés.
          </p>
          ...
          <p>
            Usted tiene el derecho, en todo momento, a solicitar a ABCloud la
            cancelación (eliminación) de sus datos personales cuando considere
            que los mismos no están siendo tratados conforme a los principios,
            deberes y obligaciones previstas en la Legislación Vigente
            Aplicable. Esta cancelación implica la supresión total o parcial de
            la información personal de acuerdo con lo solicitado por el titular
            en los registros, archivos, bases de datos o tratamientos realizados
            por el responsable, previo bloqueo.
          </p>
          <p>
            Si usted quiere ejercer sus derechos ARCO respecto a sus datos
            personales que estén en posesión de ABCloud lo podrá realizar
            enviando la solicitud para ejercer sus derechos ARCO, a nuestro
          ...
          <p>
            ...
            domicilio de ABCloud señalado en el numeral XIII DATOS DE CONTACTO.
          </p>
          <p>
            {" "}
            Para responder a su solicitud ABCloud tendrá un plazo de veinte (20)
            días hábiles contados a partir de la fecha en que recibió la
            solicitud para responder. Si la solicitud es procedente, se hará
            efectiva dentro de los quince (15) días hábiles siguientes a la
            fecha en que se le haya comunicado la respuesta anterior. Estos
            plazos podrán ser ampliados por una sola vez y por un periodo igual,
            cuando las circunstancias del caso lo ameriten. La entrega de
            información procederá previa acreditación de su identidad o de su
            representante legal, según corresponda. Si usted deseara revocar el
            consentimiento otorgado para el tratamiento de datos personales por
            parte del ABCloud lo deberá informar a ésta por escrito de la misma
            manera.
          </p>
          <p>
            Al momento en que usted haga la revocación del uso de sus datos
            personales existe la posibilidad de que ABCloud no pueda seguir
            prestándole sus servicios o productos.
          </p>
          <p>
            ...
            15 días siguientes a la fecha en que reciba la respuesta de ABCloud
          ...
          <p>
            ...
            el Titular otorga a ABCloud su consentimiento para llevar a cabo el
            tratamiento de los Datos Personales que hubieran sido proporcionados
            y/o los que con motivo de alguna de las finalidades establecidas en
            el presente proporcione en lo futuro.
          </p>
          ...
          <p>
            {" "}
            No obstante que ABCloud utiliza la tecnología más avanzada para
            salvaguardar los datos que proporciona el Titular, existe la
            ...
            información. Aún y cuando esta situación se llegará a dar, tus datos
            están protegidos mediante procesos de cifrado avanzado que hacen
            imposible la recuperación útil de la información por un tercero
            ajeno a ABCloud. Nuestra garantía es hacer todo lo que
            razonablemente esté a nuestro alcance para resguardar tus datos.
          </p>
          <p>
          ...
          <p>
            ...
            contrario, ABCloud procederá a la cancelación de los datos
            personales, en su posesión previo bloqueo de los mismos, para su
            posterior supresión.
          </p>
          ...
          <p>
            ...
            ajenos a ABCloud escuela al revés puede coincidir con aquella que
            has alimentado o alimentarás en los formularios de ABCloud.
          </p>
          <p>
            ...
            ABCloud, en los demás sitios en los que navegues o alimentes
          ...
          <p>
            ...
            postal del usuario. Por motivos de seguridad, ABCloud no recopila ni
            almacena datos confidenciales del titular de la tarjeta, como todos
            los números de la tarjeta de crédito o los datos de autenticación de
            la tarjeta.
          </p>
          <h5>XV. TARIFAS</h5>
          <p>
            {" "}
            ABCloud se reserva el derecho de cambiar sus tarifas o cargos por
            los servicios ofrecidos en el Sitio Web (o de comenzar a cobrar por
            cualquier servicio gratuito), tomando en cuenta que las tarifas
            pagadas antes de dichos cambios no resultarán afectadas, sin
            embargo, podrán tener cambios, como no poder seguir tomando un curso
            de manera gratuita hasta no realizar el pago correspondiente.
          </p>
          ...
          <p>
            ...
            datos o similares) distintos de aquellos provistos por ABCloud
          ...
          <p>
            {" "}
            ABCloud se reserva el aviso y en cualquier momento la prestación de
            los Servicios y el acceso a Contenidos en el Sitio Web a aquellos
            Usuarios que infrinjan los presentes Términos y Condiciones de Uso.
          </p>
          ...
          <p>
            ...
            Sitio Web. Todas las clases en ABCloud se mantendrán disponibles
            para acceso ilimitado, a menos que se dé de bajo el contenido por
          ...
          <p>
            {" "}
            Tus datos son tratados y resguardados por ABCloud; si como Titular
            tienes alguna duda o preocupación en relación a la presente política
            de privacidad o la forma en que manejamos los datos que nos
          ...
          <Box display="flex" justifyContent="center" textAlign="center">
            <div>
              ...
              <br />
              <small> Copyright © ABCloud 2020</small>
            </div>
          </Box>
        </Box>
      </Box>
