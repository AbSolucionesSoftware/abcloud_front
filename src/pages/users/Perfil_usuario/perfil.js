...
export default function PerfilUsuario(props) {
  ...
  const obtenerDatosBD = useCallback(async () => {
    if (!user._id) return;
    setLoading(true);
    await clienteAxios
      .get(`/user/${user._id}`, {
              ...
              <ButtonBase focusRipple className={classes.image}>
                ...
                {datos.urlImage ? (
                  ...
                  <Box
                    ...
                    className={classes.imageSrc}
                  >
                    <AccountBoxIcon style={{ fontSize: 100, opacity: 0.5 }} />
                  </Box>
                )}
                ...
                <span className={classes.imageButton}>
                  <Grid container direction="column">
                    ...
                    >
                      <CameraAltIcon style={{ fontSize: 60, opacity: 0.7 }} />
                    </Typography>
                    {/* <Typography
                      component="span"
                      color="inherit"
                    ...
                    >
                      {isDragActive ? (
                        ...
                        <Typography>
                          Arrastra y suelta un archivo o selecciona uno haciendo
                          click
                        </Typography>
                      )}
                    </Typography> */}
          ...
          <Grid container direction="row" spacing={2}>
            ...
            <Grid item lg={6} md={6} xs={12}>
              ...
              >
                ...
                >
                  ...
                  <MenuItem value="Educación Primaria">
                    Educación Primaria
                  </MenuItem>
                  <MenuItem value="Educación secundaria">
                  ...
                  <MenuItem value="Educación media superior, técnico superior, licenciatura o postgrado">
                    Educación media superior, técnico superior, licenciatura o
                    postgrado
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            <Grid item lg={6} md={6} xs={12}>
              <TextField
                ...
                className={classes.root + " no-spin"}
              />
            </Grid>
            <Grid item lg={6} md={6} xs={12}>
              <TextField
