...
import ComentariosDelCurso from "../Comentarios/ListaComentarios";
...
export default function VistaCursoContenidoInfo({ curso }) {
  ...
  return (
    <Fragment>
      ...
      <Box className={classes.containerBody} pb={1}>
        <Breadcrumbs
        ...
        >
          <Link
            color="inherit"
            href={`/busqueda/${curso.course.category}`}
            target="_blank"
            rel="noopener"
          >
          ...
          <Link
            color="inherit"
            href={`/busqueda/${curso.course.subCategory}`}
            target="_blank"
            rel="noopener"
          >
        ...
        <Box my={1}>
          <Grid container spacing={2}>
            <Grid item>
              <Rating
                name="read-only"
                value={curso.course.qualification}
                precision={0.5}
                readOnly
              />
            </Grid>
        ...
        <Typography>
          {`Creado el ${formatoFechaCurso(curso.course.createdAt)} por ${
      ...
      <Box minHeight="50vh" className={classes.containerBody}>
